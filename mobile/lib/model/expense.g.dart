...
extension ExpenseQueryWhereSort on QueryBuilder<Expense, Expense, QWhere> {
  ...
  QueryBuilder<Expense, Expense, QAfterWhere> anyDateTime() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQueryWhere on QueryBuilder<Expense, Expense, QWhereClause> {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> dateTimeEqualTo(
      DateTime dateTime) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> dateTimeNotEqualTo(
      DateTime dateTime) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> dateTimeGreaterThan(
    DateTime dateTime, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> dateTimeLessThan(
    DateTime dateTime, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> dateTimeBetween(
